    ...
    if start_button:
        ...
        if hands:
            ...
            if hand2:
                ...
                if x2 - offset >= 0 and y2 - offset >= 0 and x2 + w2 + offset < img.shape[1] and y2 + h2 + offset < \
                        img.shape[0]:
            ...
            cv2.rectangle(imgOutput, (0, 0),
                          (720, 120), (255, 255, 255), cv2.FILLED)
            if index >= 0 and index < len(labels):
                ...
                if index == 26 :
                    labels2.clear()
                cv2.putText(imgOutput, LtoS(labels2), (20, 80), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2)
